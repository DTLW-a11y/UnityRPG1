...
public class elimination : EnemyState
{
    EnemyMaster enemy;
    SpriteRenderer spriteRenderer;
     float flashtime = .3f;
    public elimination(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animBoolName, EnemyMaster enemy) : base(_enemyBase, _stateMachine, _animBoolName)
    {
        this.enemy =enemy;
    }
