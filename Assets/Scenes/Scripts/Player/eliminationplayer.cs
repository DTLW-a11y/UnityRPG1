...
public class eliminationplayer : PlayerState
{
    Player enemy;
    SpriteRenderer spriteRenderer;
    float flashtime = .3f;

    public eliminationplayer(Player _player, PlayerStateMachine _stateMachine, string _animBoolName) : base(_player, _stateMachine, _animBoolName)
    {
        enemy = _player;
    }
