...
public class Inventory : MonoBehaviour
{
    ...
    private void LoadAllFiles()//将itemdata放入resource/itemdata文件夹，将编号与文件放入字典
    {
    ...
    public bool CanCraft(itemData_equipment itemToCraft, List<InventoryItem> requirements)  //物品合成判断
    {
